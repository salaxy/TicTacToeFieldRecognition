                        ...
                        if (area > 20000 and area< 60000):
                            ...
                            if(formFactor>0.55 and formFactor<0.7):
                                ...
                                if(len(approx)==4):
                                    ...
                                    M = cv2.getPerspectiveTransform(rect, dst)
                                    warp = cv2.warpPerspective(roiFrame, M, (maxWidth, maxHeight))
